...
public class TerminalScript : MonoBehaviour
{
    ...
    [SerializeField] private WorkerPartsPrefabs memberPartsPrefabs;
    [SerializeField] private WorkerPartsPrefabs corePartsPrefabs;
    ...
    private void FillRobotPartsQueues()
    {
        ...
        {
            memberPartsQueue.Enqueue(memberPartsPrefabs.collection[Random.Range(0, memberPartsPrefabs.collection.Length)]);
            corePartsQueue.Enqueue(corePartsPrefabs.collection[Random.Range(0, corePartsPrefabs.collection.Length)]);
        }
    }
